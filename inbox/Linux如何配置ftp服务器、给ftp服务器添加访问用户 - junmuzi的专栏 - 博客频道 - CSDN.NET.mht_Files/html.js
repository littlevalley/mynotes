...
!(function(){
  ...
  var setCookie = function (name,value) {
    ...
    document.cookie = name + "="+ escape (value) + ";expires=" + exp.toGMTString();// + ";domain=.csdn.net;path=Linux_E5_A6_82_E4_BD_95_E9_85_8D_E7_BD_AEftp_E6_9C_8D_E_68.html";
  }
  ...
  var AUtoAvatar = function(AU){
    ...
    var _AUPath = AU.split("").join("Linux_E5_A6_82_E4_BD_95_E9_85_8D_E7_BD_AEftp_E6_9C_8D_E_68.html");
                ...
                <div id="cappsarea123" class="icon on-apps-icon">\
                  ...
                  <div class="detail">\
                    <dl>\
                      ...
                      <dd style="display:none"> <a href="http://job.csdn.net?ref=toolbar" target="_blank">JOB<img src="new_52.gif" style="display: none; margin-top: -26px; width: 23px;"></a></dd>\
                      <dd> <a href="http://edu.csdn.net?ref=toolbar" target="_blank">学院<img src="new_52.gif" style="display: none; margin-top: -26px; width: 23px;"></a></dd>\
                      ...
                      <dd> <a href="http://mall.csdn.net?ref=toolbar" target="_blank">C币兑换<img src="new_52.gif" style="display: none; margin-top: -26px; width: 23px;"></a></dd>\
                    </dl>\
                  </div>\
