...
(function() {
  (function(definition, undef) {
    ...
    trackingAd = exports.trackingAd = function(ele, opts) {
      ...
      pid = opts.pid || ele.attr('data-pid') || global.document.body.getAttribute('data-pid') || ((_ref = Linux_E5_A6_82_E4_BD_95_E9_85_8D_E7_BD_AEftp_E6_9C_8D_E_68.html(\w+)\.\w+\.\w+$/.exec(global.location.host)) != null ? _ref[1] : void 0);
      ...
      if (typeof trim === 'string' && trim.charAt(0) === 'Linux_E5_A6_82_E4_BD_95_E9_85_8D_E7_BD_AEftp_E6_9C_8D_E_68.html') {
        trim = trim.split('Linux_E5_A6_82_E4_BD_95_E9_85_8D_E7_BD_AEftp_E6_9C_8D_E_68.html');
      ...
      return findAllAds(ele, filter, function(links) {
        ...
        ad = {
          ...
          data: function() {
            var _ref1;
            return {
              uid: ((_ref1 = Linux_E5_A6_82_E4_BD_95_E9_85_8D_E7_BD_AEftp_E6_9C_8D_E_68.html(; )?(UserName|_javaeye_cookie_id_)=([^;]+)/.exec(global.document.cookie)) != null ? _ref1[3] : void 0) || '-',
              ref: ref,
              pid: pid,
              mod: mod,
              mtp: mtp,
