...
(function(){
    $(function(){
        ...
        var second_pop_str="<div class='pop_edit ask_second comm_ask_second'><h3>提问</h3><span class='ask_float_span'>您的问题将会被发布在“<a class='ask_float_channel' href='//ask.csdn.net' target='_blank' style='cursor:pointer'>技术问答</a>”频道</span><a href='#' nodeType='close' class='close'>×</a><div class='context'><div class='err_div'><span class='err_ico'></span>"+
            ...
            "<div class='pop_cm cm_add_img'><div class='nav-tabs'><a class='img_tab active' href='#tab_upload'>本地上传</a><a class='img_tab' href='#tab_weburl'>网络图片</a></div><div class='tab_panel active' id='tab_upload'><div class='set_img'><iframe src='upload_106.html'></iframe></div></div><div class='tab_panel' id='tab_weburl'><input type='text' placeholder='图片地址' id='af_cm_img_url'><input type='text' placeholder='图片说明' id='af_cm_img_alt'><div class='text-right'><span class='btn btn-default btn-sm' id='add_img_btn'>插入图片</span> </div></div> </div></div> "+
        ...
        function Creat_Dynamic_Tag(conid,dataurl,subinput)
        {
            ...
            tagInput.onblur = function()
            {
                ...
                else
                {
                    ...
                    var re=Linux_E5_A6_82_E4_BD_95_E9_85_8D_E7_BD_AEftp_E6_9C_8D_E_68.html[^0-9a-zA-Z\u4e00-\u9fa5\-+#]+/;
                    var re2 = Linux_E5_A6_82_E4_BD_95_E9_85_8D_E7_BD_AEftp_E6_9C_8D_E_68.html\-$/;
                    var re3 = Linux_E5_A6_82_E4_BD_95_E9_85_8D_E7_BD_AEftp_E6_9C_8D_E_68.html^\-/;
