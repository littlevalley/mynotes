...
function loadList(pageIndex, isSub) {
    ...
    var url = location.href.toString().split('Linux_E5_A6_82_E4_BD_95_E9_85_8D_E7_BD_AEftp_E6_9C_8D_E_68.html');
    var cmtUrl = "http://"+url[2]+"Linux_E5_A6_82_E4_BD_95_E9_85_8D_E7_BD_AEftp_E6_9C_8D_E_68.html"+url[3]+"/comment/list/" + fileName + "?page=" + (pageIndex || 1);
...
function replaceUBBToHTML(comment) {
    ...
    var re = Linux_E5_A6_82_E4_BD_95_E9_85_8D_E7_BD_AEftp_E6_9C_8D_E_68.html\[code=([\w#\.]+)\]([\s\S]*?)\[\/code\]/ig;
    ...
    if (codelist.length > 0) {
        var re1 = Linux_E5_A6_82_E4_BD_95_E9_85_8D_E7_BD_AEftp_E6_9C_8D_E_68.html--code--/ig;
        var i = 0;
...
function replaceQuote(str) {
    var m = Linux_E5_A6_82_E4_BD_95_E9_85_8D_E7_BD_AEftp_E6_9C_8D_E_68.html\[quote=([^\]]+)]([\s\S]*)\[\/quote\]/gi.exec(str);
    if (m) {
