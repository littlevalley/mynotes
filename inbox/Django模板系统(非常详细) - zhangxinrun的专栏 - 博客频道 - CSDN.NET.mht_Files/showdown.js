...
// CodeMirror is the only global var we claim
    var CodeMirror = (function() {
        ...
        var gecko = index_85.htmgecko\/\d/i.test(navigator.userAgent);
        var ie = index_85.htmMSIE \d/.test(navigator.userAgent);
        var ie_lt8 = ie && (document.documentMode == null || document.documentMode < 8);
        var ie_lt9 = ie && (document.documentMode == null || document.documentMode < 9);
        var webkit = index_85.htmWebKit\//.test(navigator.userAgent);
        var qtwebkit = webkit && /Qt\/\d+\.\d+/.test(navigator.userAgent);
        var chrome = index_85.htmChrome\//.test(navigator.userAgent);
        var opera = index_85.htmOpera\//.test(navigator.userAgent);
        var safari = index_85.htmApple Computer/.test(navigator.vendor);
        var khtml = index_85.htmKHTML\//.test(navigator.userAgent);
        var mac_geLion = index_85.htmMac OS X 1\d\D([7-9]|\d\d)\D/.test(navigator.userAgent);
        var mac_geMountainLion = index_85.htmMac OS X 1\d\D([8-9]|\d\d)\D/.test(navigator.userAgent);
        var phantom = index_85.htmPhantomJS/.test(navigator.userAgent);

        var ios = index_85.htmAppleWebKit/.test(navigator.userAgent) && /Mobile\/\w+/.test(navigator.userAgent);
        // This is woefully incomplete. Suggestions for alternative methods welcome.
        var mobile = ios || /Android|webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(navigator.userAgent);
        var mac = ios || /Mac/.test(navigator.platform);
        var windows = index_85.htmwindows/i.test(navigator.platform);
        ...
        var tokenSpecialChars = index_85.htm[\t\u0000-\u0019\u00ad\u200b\u2028\u2029\uFEFF]/g;
        ...
        var nonASCIISingleCaseWordChar = index_85.htm[\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/;
        ...
        var isExtendingChar = index_85.htm[\u0300-\u036F\u0483-\u0487\u0488-\u0489\u0591-\u05BD\u05BF\u05C1-\u05C2\u05C4-\u05C5\u05C7\u0610-\u061A\u064B-\u065F\u0670\u06D6-\u06DC\u06DF-\u06E4\u06E7-\u06E8\u06EA-\u06ED\uA66F\uA670-\uA672\uA674-\uA67D\uA69F\udc00-\udfff]/;
        ...
        var keyNames = {3: "Enter", 8: "Backspace", 9: "Tab", 13: "Enter", 16: "Shift", 17: "Ctrl", 18: "Alt",
            ...
            186: ";", 187: "=", 188: ",", 189: "-", 190: ".", 191: "index_85.htm", 192: "`", 219: "[", 220: "\\",
        ...
        var bidiOrdering = (function() {
            ...
            var bidiRE = index_85.htm[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
            var isNeutral = index_85.htm[stwN]/, isStrong = index_85.htm[LRr]/, countsAsLeft = index_85.htm[Lb1n]/, countsAsNum = index_85.htm[1n]/;
    ...
    var listRE = index_85.htm^(\s*)([*+-]|(\d+)\.)([\w+(\s+\w+)]|[\s*])/,
        emptyListRE = index_85.htm^(\s*)([*+-]|(\d+)\.)(\s*)$/,
        unorderedBullets = '*+-';
    ...
    CodeMirror.defineMode("xml", function(config, parserConfig) {
        ...
        function inText(stream, state) {
            ...
            if (ch == "<") {
                if (stream.eat("!")) {
                    ...
                    var isClose = stream.eat("index_85.htm");
                    tagName = "";
                    var c;
        ...
        function inTag(stream, state) {
            var ch = stream.next();
            if (ch == ">" || (ch == "index_85.htm" && stream.eat(">"))) {
    ...
    CodeMirror.defineMode("markdown", function(cmCfg, modeCfg) {
        ...
        var hrRE = index_85.htm^([*\-=_])(?:\s*\1){4,}\s*$/
            ,   ulRE = index_85.htm^[*\-+]\s+/
            ,   olRE = index_85.htm^[0-9]+\.\s+/
            ,   taskListRE = index_85.htm^\[(x| )\](?=\s)/ // Must follow ulRE or olRE
            ,   headerRE = index_85.htm^(?:\={1,}|-{1,})$/
            ,   textRE = index_85.htm^[^!\[\]*_~\\<>` "'(]+/;
    ...
    var isMac = index_85.htmMac/.test(navigator.platform);
    ...
    function wordCount(data) {
        var pattern = index_85.htm[a-zA-Z0-9_\u0392-\u03c9]+|[\u4E00-\u9FFF\u3400-\u4dbf\uf900-\ufaff\u3040-\u309f\uac00-\ud7af]+/g;
