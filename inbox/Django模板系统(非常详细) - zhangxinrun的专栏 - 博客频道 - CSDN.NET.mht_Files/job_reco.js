...
引用方法：<script src="job_reco.js" type="text/javascript"></script>
...
<div id="job_blog_reco">
 <script src="job_reco.js" type="text/javascript"></script>
...
//--------------------------------------------------------------------------------------------------------------------------------
    ...
    this.search_reco_edu_item = '<div class="po_search_item_div">' +
      ...
      this.blog_reco_edu_item = '<dd style="background:url(blog-dot-red3.gif) no-repeat 0 10px; white-space: nowrap;">' +
