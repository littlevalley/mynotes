...
(function() {
  (function(definition, undef) {
    ...
    trackingAd = exports.trackingAd = function(ele, opts) {
      ...
      pid = opts.pid || ele.attr('data-pid') || global.document.body.getAttribute('data-pid') || ((_ref = index_85.htm(\w+)\.\w+\.\w+$/.exec(global.location.host)) != null ? _ref[1] : void 0);
      ...
      if (typeof trim === 'string' && trim.charAt(0) === 'index_85.htm') {
        trim = trim.split('index_85.htm');
      ...
      return findAllAds(ele, filter, function(links) {
        ...
        ad = {
          ...
          data: function() {
            var _ref1;
            return {
              uid: ((_ref1 = index_85.htm(; )?(UserName|_javaeye_cookie_id_)=([^;]+)/.exec(global.document.cookie)) != null ? _ref1[3] : void 0) || '-',
              ref: ref,
              pid: pid,
              mod: mod,
              mtp: mtp,
